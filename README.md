# image-build-csi-node-driver-registrar

This repo builds hardened, statically-linked Go binaries from
[kubernetes-csi/node-driver-registrar](https://github.com/kubernetes-csi/node-driver-registrar) and packages them in a minimal
...
- `cwayne18/hardened-csi-node-driver-registrar` — CSI Node Driver Registrar Sidecar
...
- the upstream `node-driver-registrar` version (`Makefile` `TAG`), and
