...
.PHONY: build-image-csi-node-driver-registrar
build-image-csi-node-driver-registrar: IMAGE = $(REPO)/hardened-csi-node-driver-registrar:$(TAG)
...
.PHONY: push-image-csi-node-driver-registrar
push-image-csi-node-driver-registrar: IMAGE = $(REPO)/hardened-csi-node-driver-registrar:$(TAG)
push-image-csi-node-driver-registrar:
	docker buildx build \
		$(IID_FILE_FLAG) \
		--sbom=true \
